...
private:
    ...
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithNormalMapAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithoutNormalMapAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithNormalMapNoMrAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithoutNormalMapNoMrAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithNormalMapNoBaseColorAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithoutNormalMapNoBaseColorAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithNormalMapNoMrNoBaseColorAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithoutNormalMapNoMrNoBaseColorAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithNormalMapNoEmissiveAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithoutNormalMapNoEmissiveAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithNormalMapNoMrNoEmissiveAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithoutNormalMapNoMrNoEmissiveAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithNormalMapNoBaseColorNoEmissiveAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithoutNormalMapNoBaseColorNoEmissiveAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithNormalMapNoMrNoBaseColorNoEmissiveAlphaMask;
    Microsoft::WRL::ComPtr<ID3D12PipelineState> BasePassPipelineWithoutNormalMapNoMrNoBaseColorNoEmissiveAlphaMask;
